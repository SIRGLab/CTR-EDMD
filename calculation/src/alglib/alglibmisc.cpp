...
_kdtreerequestbuffer_owner::_kdtreerequestbuffer_owner(const _kdtreerequestbuffer_owner &rhs)
{
  ...
  alglib_impl::ae_assert(rhs.p_struct != NULL,
                         "ALGLIB: kdtreerequestbuffer copy constructor failure (source is not initialized)", &_state);
  p_struct =
      (alglib_impl::kdtreerequestbuffer *)alglib_impl::ae_malloc(sizeof(alglib_impl::kdtreerequestbuffer), &_state);
  memset(p_struct, 0, sizeof(alglib_impl::kdtreerequestbuffer));
  alglib_impl::_kdtreerequestbuffer_init_copy(p_struct, const_cast<alglib_impl::kdtreerequestbuffer *>(rhs.p_struct),
                                              &_state, ae_false);
  ae_state_clear(&_state);
}
...
_kdtree_owner::_kdtree_owner(const _kdtree_owner &rhs)
{
  ...
  alglib_impl::ae_state_set_break_jump(&_state, &_break_jump);
  p_struct = NULL;
  alglib_impl::ae_assert(rhs.p_struct != NULL, "ALGLIB: kdtree copy constructor failure (source is not initialized)",
                         &_state);
  p_struct = (alglib_impl::kdtree *)alglib_impl::ae_malloc(sizeof(alglib_impl::kdtree), &_state);
  memset(p_struct, 0, sizeof(alglib_impl::kdtree));
...
_kdtree_owner &_kdtree_owner::operator=(const _kdtree_owner &rhs)
{
  ...
  alglib_impl::ae_state_set_break_jump(&_state, &_break_jump);
  alglib_impl::ae_assert(p_struct != NULL,
                         "ALGLIB: kdtree assignment constructor failure (destination is not initialized)", &_state);
  alglib_impl::ae_assert(rhs.p_struct != NULL,
                         "ALGLIB: kdtree assignment constructor failure (source is not initialized)", &_state);
  alglib_impl::_kdtree_destroy(p_struct);
  memset(p_struct, 0, sizeof(alglib_impl::kdtree));
  alglib_impl::_kdtree_init_copy(p_struct, const_cast<alglib_impl::kdtree *>(rhs.p_struct), &_state, ae_false);
  ae_state_clear(&_state);
...
*************************************************************************/
void kdtreebuild(const real_2d_array &xy, const ae_int_t n, const ae_int_t nx, const ae_int_t ny,
                 const ae_int_t normtype, kdtree &kdt, const xparams _xparams)
{
  ...
  alglib_impl::kdtreebuild(const_cast<alglib_impl::ae_matrix *>(xy.c_ptr()), n, nx, ny, normtype,
...
2. Although KD-trees may be used with any combination of N  and  NX,  they
  ...
  -- ALGLIB --
     Copyright 28.02.2010 by Bochkanov Sergey
*************************************************************************/
void kdtreebuildtagged(const real_2d_array &xy, const integer_1d_array &tags, const ae_int_t n, const ae_int_t nx,
                       const ae_int_t ny, const ae_int_t normtype, kdtree &kdt, const xparams _xparams)
{
  jmp_buf _break_jump;
  alglib_impl::ae_state _alglib_env_state;
  alglib_impl::ae_state_init(&_alglib_env_state);
...
*************************************************************************/
#if !defined(AE_NO_EXCEPTIONS)
void kdtreebuildtagged(const real_2d_array &xy, const integer_1d_array &tags, const ae_int_t nx, const ae_int_t ny,
                       const ae_int_t normtype, kdtree &kdt, const xparams _xparams)
{
  jmp_buf _break_jump;
  alglib_impl::ae_state _alglib_env_state;
                        ...
                        const xparams _xparams)
{
  ...
  alglib_impl::ae_int_t result =
      alglib_impl::kdtreequeryknn(const_cast<alglib_impl::kdtree *>(kdt.c_ptr()),
                                  const_cast<alglib_impl::ae_vector *>(x.c_ptr()), k, selfmatch, &_alglib_env_state);
  alglib_impl::ae_state_clear(&_alglib_env_state);
                          ...
                          const bool selfmatch, const xparams _xparams)
{
  ...
  alglib_impl::ae_int_t result = alglib_impl::kdtreetsqueryknn(
      const_cast<alglib_impl::kdtree *>(kdt.c_ptr()), const_cast<alglib_impl::kdtreerequestbuffer *>(buf.c_ptr()),
      const_cast<alglib_impl::ae_vector *>(x.c_ptr()), k, selfmatch, &_alglib_env_state);
  alglib_impl::ae_state_clear(&_alglib_env_state);
  return *(reinterpret_cast<ae_int_t *>(&result));
}
                        ...
                        const xparams _xparams)
{
  ...
  if (_xparams.flags != 0x0)
    ae_state_set_flags(&_alglib_env_state, _xparams.flags);
  alglib_impl::ae_int_t result =
      alglib_impl::kdtreequeryrnn(const_cast<alglib_impl::kdtree *>(kdt.c_ptr()),
                                  const_cast<alglib_impl::ae_vector *>(x.c_ptr()), r, selfmatch, &_alglib_env_state);
  alglib_impl::ae_state_clear(&_alglib_env_state);
  return *(reinterpret_cast<ae_int_t *>(&result));
}
                         ...
                         const xparams _xparams)
{
  ...
  if (_xparams.flags != 0x0)
    ae_state_set_flags(&_alglib_env_state, _xparams.flags);
  alglib_impl::ae_int_t result =
      alglib_impl::kdtreequeryrnnu(const_cast<alglib_impl::kdtree *>(kdt.c_ptr()),
                                   const_cast<alglib_impl::ae_vector *>(x.c_ptr()), r, selfmatch, &_alglib_env_state);
  alglib_impl::ae_state_clear(&_alglib_env_state);
  return *(reinterpret_cast<ae_int_t *>(&result));
}
...
* KDTreeQueryResultsDistances() to get distances
  ...
  -- ALGLIB --
     Copyright 28.02.2010 by Bochkanov Sergey
*************************************************************************/
ae_int_t kdtreequeryaknn(const kdtree &kdt, const real_1d_array &x, const ae_int_t k, const bool selfmatch,
                         const double eps, const xparams _xparams)
{
  ...
  alglib_impl::ae_int_t result = alglib_impl::kdtreequeryaknn(const_cast<alglib_impl::kdtree *>(kdt.c_ptr()),
                                                              const_cast<alglib_impl::ae_vector *>(x.c_ptr()), k,
                                                              selfmatch, eps, &_alglib_env_state);
  alglib_impl::ae_state_clear(&_alglib_env_state);
  return *(reinterpret_cast<ae_int_t *>(&result));
}
...
IMPORTANT: kd-tree buffer should be used only with  KD-tree  object  which
  ...
  -- ALGLIB --
     Copyright 18.03.2016 by Bochkanov Sergey
*************************************************************************/
ae_int_t kdtreetsqueryaknn(const kdtree &kdt, const kdtreerequestbuffer &buf, const real_1d_array &x, const ae_int_t k,
                           const bool selfmatch, const double eps, const xparams _xparams)
{
  jmp_buf _break_jump;
  alglib_impl::ae_state _alglib_env_state;
  alglib_impl::ae_state_init(&_alglib_env_state);
  ...
  alglib_impl::ae_int_t result = alglib_impl::kdtreetsqueryaknn(
      const_cast<alglib_impl::kdtree *>(kdt.c_ptr()), const_cast<alglib_impl::kdtreerequestbuffer *>(buf.c_ptr()),
      const_cast<alglib_impl::ae_vector *>(x.c_ptr()), k, selfmatch, eps, &_alglib_env_state);
  alglib_impl::ae_state_clear(&_alglib_env_state);
  return *(reinterpret_cast<ae_int_t *>(&result));
}
                        ...
                        const xparams _xparams)
{
  ...
  alglib_impl::ae_int_t result = alglib_impl::kdtreequerybox(
      const_cast<alglib_impl::kdtree *>(kdt.c_ptr()), const_cast<alglib_impl::ae_vector *>(boxmin.c_ptr()),
...
IMPORTANT: kd-tree buffer should be used only with  KD-tree  object  which
  ...
  -- ALGLIB --
     Copyright 14.05.2016 by Bochkanov Sergey
*************************************************************************/
ae_int_t kdtreetsquerybox(const kdtree &kdt, const kdtreerequestbuffer &buf, const real_1d_array &boxmin,
                          const real_1d_array &boxmax, const xparams _xparams)
{
  ...
  alglib_impl::ae_int_t result = alglib_impl::kdtreetsquerybox(
      const_cast<alglib_impl::kdtree *>(kdt.c_ptr()), const_cast<alglib_impl::kdtreerequestbuffer *>(buf.c_ptr()),
      const_cast<alglib_impl::ae_vector *>(boxmin.c_ptr()), const_cast<alglib_impl::ae_vector *>(boxmax.c_ptr()),
      &_alglib_env_state);
  alglib_impl::ae_state_clear(&_alglib_env_state);
  return *(reinterpret_cast<ae_int_t *>(&result));
}
...
_hqrndstate_owner::_hqrndstate_owner(const _hqrndstate_owner &rhs)
{
  ...
  p_struct = NULL;
  alglib_impl::ae_assert(rhs.p_struct != NULL,
                         "ALGLIB: hqrndstate copy constructor failure (source is not initialized)", &_state);
  p_struct = (alglib_impl::hqrndstate *)alglib_impl::ae_malloc(sizeof(alglib_impl::hqrndstate), &_state);
  memset(p_struct, 0, sizeof(alglib_impl::hqrndstate));
...
_hqrndstate_owner &_hqrndstate_owner::operator=(const _hqrndstate_owner &rhs)
{
  ...
  alglib_impl::ae_state_set_break_jump(&_state, &_break_jump);
  alglib_impl::ae_assert(p_struct != NULL,
                         "ALGLIB: hqrndstate assignment constructor failure (destination is not initialized)", &_state);
  alglib_impl::ae_assert(rhs.p_struct != NULL,
                         "ALGLIB: hqrndstate assignment constructor failure (source is not initialized)", &_state);
  alglib_impl::_hqrndstate_destroy(p_struct);
  memset(p_struct, 0, sizeof(alglib_impl::hqrndstate));
  alglib_impl::_hqrndstate_init_copy(p_struct, const_cast<alglib_impl::hqrndstate *>(rhs.p_struct), &_state, ae_false);
  ae_state_clear(&_state);
...
_xdebugrecord1_owner::_xdebugrecord1_owner(const _xdebugrecord1_owner &rhs)
{
  ...
  p_struct = NULL;
  alglib_impl::ae_assert(rhs.p_struct != NULL,
                         "ALGLIB: xdebugrecord1 copy constructor failure (source is not initialized)", &_state);
  p_struct = (alglib_impl::xdebugrecord1 *)alglib_impl::ae_malloc(sizeof(alglib_impl::xdebugrecord1), &_state);
  memset(p_struct, 0, sizeof(alglib_impl::xdebugrecord1));
  alglib_impl::_xdebugrecord1_init_copy(p_struct, const_cast<alglib_impl::xdebugrecord1 *>(rhs.p_struct), &_state,
                                        ae_false);
  ae_state_clear(&_state);
}
...
_xdebugrecord1_owner &_xdebugrecord1_owner::operator=(const _xdebugrecord1_owner &rhs)
{
  ...
  alglib_impl::ae_assert(p_struct != NULL,
                         ...
                         &_state);
  alglib_impl::ae_assert(rhs.p_struct != NULL,
                         "ALGLIB: xdebugrecord1 assignment constructor failure (source is not initialized)", &_state);
  alglib_impl::_xdebugrecord1_destroy(p_struct);
  memset(p_struct, 0, sizeof(alglib_impl::xdebugrecord1));
  alglib_impl::_xdebugrecord1_init_copy(p_struct, const_cast<alglib_impl::xdebugrecord1 *>(rhs.p_struct), &_state,
                                        ae_false);
...
ae_int_t xdebugb1count(const boolean_1d_array &a, const xparams _xparams)
{
  ...
  if (_xparams.flags != 0x0)
    ae_state_set_flags(&_alglib_env_state, _xparams.flags);
  alglib_impl::ae_int_t result =
      alglib_impl::xdebugb1count(const_cast<alglib_impl::ae_vector *>(a.c_ptr()), &_alglib_env_state);
  alglib_impl::ae_state_clear(&_alglib_env_state);
  return *(reinterpret_cast<ae_int_t *>(&result));
}
...
ae_int_t xdebugi1sum(const integer_1d_array &a, const xparams _xparams)
{
  ...
  if (_xparams.flags != 0x0)
    ae_state_set_flags(&_alglib_env_state, _xparams.flags);
  alglib_impl::ae_int_t result =
      alglib_impl::xdebugi1sum(const_cast<alglib_impl::ae_vector *>(a.c_ptr()), &_alglib_env_state);
  alglib_impl::ae_state_clear(&_alglib_env_state);
  return *(reinterpret_cast<ae_int_t *>(&result));
}
...
alglib::complex xdebugc1sum(const complex_1d_array &a, const xparams _xparams)
{
  ...
  if (_xparams.flags != 0x0)
    ae_state_set_flags(&_alglib_env_state, _xparams.flags);
  alglib_impl::ae_complex result =
      alglib_impl::xdebugc1sum(const_cast<alglib_impl::ae_vector *>(a.c_ptr()), &_alglib_env_state);
  alglib_impl::ae_state_clear(&_alglib_env_state);
...
ae_int_t xdebugb2count(const boolean_2d_array &a, const xparams _xparams)
{
  ...
  if (_xparams.flags != 0x0)
    ae_state_set_flags(&_alglib_env_state, _xparams.flags);
  alglib_impl::ae_int_t result =
      alglib_impl::xdebugb2count(const_cast<alglib_impl::ae_matrix *>(a.c_ptr()), &_alglib_env_state);
  alglib_impl::ae_state_clear(&_alglib_env_state);
  return *(reinterpret_cast<ae_int_t *>(&result));
}
...
ae_int_t xdebugi2sum(const integer_2d_array &a, const xparams _xparams)
{
  ...
  if (_xparams.flags != 0x0)
    ae_state_set_flags(&_alglib_env_state, _xparams.flags);
  alglib_impl::ae_int_t result =
      alglib_impl::xdebugi2sum(const_cast<alglib_impl::ae_matrix *>(a.c_ptr()), &_alglib_env_state);
  alglib_impl::ae_state_clear(&_alglib_env_state);
  return *(reinterpret_cast<ae_int_t *>(&result));
}
...
alglib::complex xdebugc2sum(const complex_2d_array &a, const xparams _xparams)
{
  ...
  if (_xparams.flags != 0x0)
    ae_state_set_flags(&_alglib_env_state, _xparams.flags);
  alglib_impl::ae_complex result =
      alglib_impl::xdebugc2sum(const_cast<alglib_impl::ae_matrix *>(a.c_ptr()), &_alglib_env_state);
  alglib_impl::ae_state_clear(&_alglib_env_state);
  return *(reinterpret_cast<alglib::complex *>(&result));
}
...
Returns sum of a[i,j]*(1+b[i,j]) such that c[i,j] is True
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
double xdebugmaskedbiasedproductsum(const ae_int_t m, const ae_int_t n, const real_2d_array &a, const real_2d_array &b,
                                    const boolean_2d_array &c, const xparams _xparams)
{
  jmp_buf _break_jump;
  alglib_impl::ae_state _alglib_env_state;
  alglib_impl::ae_state_init(&_alglib_env_state);
  ...
  double result = alglib_impl::xdebugmaskedbiasedproductsum(
      m, n, const_cast<alglib_impl::ae_matrix *>(a.c_ptr()), const_cast<alglib_impl::ae_matrix *>(b.c_ptr()),
...
static ae_int_t nearestneighbor_tsqueryrnn(kdtree *kdt, kdtreerequestbuffer *buf,
                                           /* Real    */ ae_vector *x, double r, ae_bool selfmatch,
                                           ae_bool orderedbydist, ae_state *_state);
static void nearestneighbor_kdtreesplit(kdtree *kdt, ae_int_t i1, ae_int_t i2, ae_int_t d, double s, ae_int_t *i3,
                                        ae_state *_state);
static void nearestneighbor_kdtreegeneratetreerec(kdtree *kdt, ae_int_t *nodesoffs, ae_int_t *splitsoffs, ae_int_t i1,
...
static void nearestneighbor_kdtreeinitbox(kdtree *kdt,
                                          /* Real    */ ae_vector *x, kdtreerequestbuffer *buf, ae_state *_state);
...
2. Although KD-trees may be used with any combination of N  and  NX,  they
  ...
  -- ALGLIB --
     Copyright 28.02.2010 by Bochkanov Sergey
*************************************************************************/
void kdtreebuild(/* Real    */ ae_matrix *xy, ae_int_t n, ae_int_t nx, ae_int_t ny, ae_int_t normtype, kdtree *kdt,
                 ae_state *_state)
{
...
void kdtreebuildtagged(/* Real    */ ae_matrix *xy,
                       /* Integer */ ae_vector *tags, ae_int_t n, ae_int_t nx, ae_int_t ny, ae_int_t normtype,
                       kdtree *kdt, ae_state *_state)
{
  ae_int_t i;
  ae_int_t j;
  ae_int_t nodesoffs;
  ...
  ae_assert(apservisfinitematrix(xy, n, nx + ny, _state), "KDTreeBuildTagged: XY contains infinite or NaN values",
            _state);
...
ae_int_t kdtreequeryknn(kdtree *kdt,
                        /* Real    */ ae_vector *x, ae_int_t k, ae_bool selfmatch, ae_state *_state)
{
  ae_int_t result;
...
ae_int_t kdtreequeryrnn(kdtree *kdt,
                        /* Real    */ ae_vector *x, double r, ae_bool selfmatch, ae_state *_state)
{
  ae_int_t result;
...
ae_int_t kdtreequeryaknn(kdtree *kdt,
                         /* Real    */ ae_vector *x, ae_int_t k, ae_bool selfmatch, double eps, ae_state *_state)
{
  ae_int_t result;
                          ...
                          /* Real    */ ae_vector *boxmax, ae_state *_state)
{
  ...
  ae_assert(isfinitevector(boxmin, kdt->nx, _state), "KDTreeTsQueryBox: BoxMin contains infinite or NaN values!",
            _state);
  ae_assert(isfinitevector(boxmax, kdt->nx, _state), "KDTreeTsQueryBox: BoxMax contains infinite or NaN values!",
            _state);
                           ...
                           /* Real    */ ae_matrix *x, ae_state *_state)
{
  ...
  for (i = 0; i <= k - 1; i++)
  {
    ae_v_move(&x->ptr.pp_double[i][0], 1, &kdt->xy.ptr.pp_double[buf->idx.ptr.p_int[i]][kdt->nx], 1,
              ae_v_len(0, kdt->nx - 1));
  }
}
                            ...
                            /* Real    */ ae_matrix *xy, ae_state *_state)
{
  ...
  for (i = 0; i <= k - 1; i++)
  {
    ae_v_move(&xy->ptr.pp_double[i][0], 1, &kdt->xy.ptr.pp_double[buf->idx.ptr.p_int[i]][kdt->nx], 1,
                                                  ...
                                                  ae_int_t i2, ae_int_t maxleafsize, ae_state *_state)
{
  ...
  ae_v_move(&kdt->innerbuf.buf.ptr.p_double[0], 1, &kdt->xy.ptr.pp_double[i1][d], kdt->xy.stride,
            ae_v_len(0, i2 - i1 - 1));
  n = i2 - i1;
  cntless = 0;
  cntgreater = 0;
...
static void nearestneighbor_checkrequestbufferconsistency(kdtree *kdt, kdtreerequestbuffer *buf, ae_state *_state)
{
  ...
  ae_assert(buf->buf.cnt >= ae_maxint(kdt->n, kdt->nx, _state),
            "KDTree: dimensions of kdtreerequestbuffer are inconsistent with kdtree structure", _state);
...
double xdebugmaskedbiasedproductsum(ae_int_t m, ae_int_t n,
                                    /* Real    */ ae_matrix *a,
                                    /* Real    */ ae_matrix *b,
                                    /* Boolean */ ae_matrix *c, ae_state *_state)
{
  ae_int_t i;
  ae_int_t j;
  double result;
